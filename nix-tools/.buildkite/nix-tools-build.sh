...
# https://github.com/the-blockchain-company/haskell.nix/issues/57
...
nix build --impure --expr '(let haskellNix = import (builtins.fetchTarball "https://github.com/the-blockchain-company/haskell.nix/archive/master.tar.gz") {}; in (import haskellNix.sources.nixpkgs haskellNix.nixpkgsArgs).haskell-nix.nix-tools.ghc8107)' -o nt
...
echo
echo "+++ Run tests"
echo "There are no tests -- https://github.com/the-blockchain-company/haskell.nix/issues/51"
